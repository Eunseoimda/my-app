...
function findEmail() {
  ...
  // (
  //   function ({ userName, phoneNumber, email })
  //   {
  //     return userName == nameValue && phoneValue == phoneNumber;
  //   }
  // );

  const user = data.find
  (
    ({ userName, phoneNumber, email }) => (userName == nameValue && phoneNumber == phoneValue)
  );
